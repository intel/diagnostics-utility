...
def _check_hangcheck_in_grub(value: Dict) -> None:
    ...
    try:
        ...
        value["HowToFix"] = f"{error}. Try to run the Diagnostics Utility for Intel® oneAPI Toolkits " \
...
def check_hangcheck_is_disabled(json_node: Dict) -> None:
    ...
    if (value["RetVal"] == "FAIL"):
        value["HowToFix"] = "Try disable GPU hangcheck, based on instructions from " \
            "https://www.intel.com/content/www/us/en/develop/documentation/get-started-with-intel-oneapi-hpc-linux/top/before-you-begin.html."  # noqa E501
...
def get_check_list() -> List[CheckMetadataPy]:
    hangcheckCheck = CheckMetadataPy(
        ...
        type="Data",
        tags="gpu,sysinfo,profiling,runtime,target",
