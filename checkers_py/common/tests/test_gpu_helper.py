...
class TestGpuHelper(unittest.TestCase):
    ...
    def test_intel_gpus_not_found_handler_positive(self):
        expected = {
            "Warning message": {
                "Value": "",
                "RetVal": "WARNING",
                "Message": "The checker can show irrelevant information for your system because "
    ...
    def test_are_intel_gpus_found_positive(self):
        ...
        input = {"GPU information": {"Value": {"Intel GPU(s) is present on the bus": {"RetVal": "PASS"}}}}
    ...
    def test_are_intel_gpus_found_negative(self):
        ...
        input = {"GPU information": {"Value": {"Intel GPU(s) is present on the bus": {"RetVal": "FAIL"}}}}
