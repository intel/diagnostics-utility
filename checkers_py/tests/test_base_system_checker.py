...
from checkers_py import base_system_checker  # noqa: E402
from modules.check import CheckSummary, CheckMetadataPy  # noqa: E402


class TestBaseSystemCheckerApiTest(unittest.TestCase):

    @patch("checkers_py.base_system_checker.get_hostname")
    @patch("checkers_py.base_system_checker.get_cpu_info")
    @patch("checkers_py.base_system_checker.get_bios_information")
    @patch("checkers_py.base_system_checker.get_uname")
...
class TestGetBiosInformation(unittest.TestCase):
    ...
    @patch("checkers_py.base_system_checker._get_bios_vendor")
    @patch("checkers_py.base_system_checker._get_bios_version")
    @patch("checkers_py.base_system_checker._get_bios_release")
    @patch("checkers_py.base_system_checker._get_bios_date")
...
class TestGetUname(unittest.TestCase):
    ...
    def test_get_uname_positive(self, mocked_open):
        expected = {
            "Operating system name": {
                "Value": "Linux nnltccakhvatovdev 5.11.0-34-generic "
                         "#36~20.04.1-Ubuntu SMP Fri Aug 27 08:06:32 UTC 2021 "
        ...
        uname_mock.communicate.return_value = (
            "Linux nnltccakhvatovdev 5.11.0-34-generic "
            "#36~20.04.1-Ubuntu SMP Fri Aug 27 08:06:32 UTC 2021 "
            "x86_64 x86_64 x86_64 GNU/Linux",
            None
        )
        ...
        mocked_open.return_value = uname_mock
    ...
    @patch("subprocess.Popen")
    def test_get_uname_proc_return_code_is_not_zero(self, mocked_open):
        expected = {
            "Operating system name": {
                "Value": "Undefined",
                "RetVal": "ERROR",
                "Command": "uname -a",
                "Message": "Cannot get information about operating system name"
            }
        }
    ...
    def test_get_uname_subprocess_raise_exception(self, mocked_open):
        expected = {
            "Operating system name": {
                "Value": "Undefined",
                "RetVal": "ERROR",
...
class TestGetCpuInfo(unittest.TestCase):
    ...
    @patch("subprocess.Popen")
    @patch("checkers_py.base_system_checker.get_cpu_frequency")
