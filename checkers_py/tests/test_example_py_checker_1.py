...
from checkers_py import example_py_checker_1  # noqa: E402
...
class TestExamplePyChecker1(unittest.TestCase):
    ...
    def test_run_checker1_positive(self):
        ...
        value = example_py_checker_1.run_checker1({})
    ...
    def test_get_api_version_returns_str(self):
        ...
        value = example_py_checker_1.get_api_version()
    ...
    def test_get_check_list_returns_list_metadata(self):
        ...
        value = example_py_checker_1.get_check_list()
