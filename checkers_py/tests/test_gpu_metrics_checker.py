...
from checkers_py import gpu_metrics_checker  # noqa: E402
from modules.check import CheckSummary, CheckMetadataPy  # noqa: E402


class TestGpuMetricsCheckerApiTest(unittest.TestCase):

    @patch("checkers_py.gpu_metrics_checker.parse_devices", return_value=["Device 1", "Device 2"])
    @patch("checkers_py.gpu_metrics_checker.process_device")
    ...
    @patch("checkers_py.gpu_metrics_checker.parse_devices", return_value=[])
...
class TestProcessDevice(unittest.TestCase):
    ...
    @patch("checkers_py.gpu_metrics_checker.compare_metrics_for_known_device")
    @patch("checkers_py.gpu_metrics_checker.show_metrics_for_unknown_device")
