...
from checkers_py import hangcheck_checker  # noqa: E402
from modules.check import CheckSummary, CheckMetadataPy  # noqa: E402


class TestHangcheckCheckerApiTest(unittest.TestCase):

    @patch("checkers_py.hangcheck_checker.intel_gpus_not_found_handler")
    @patch("checkers_py.hangcheck_checker.check_hangcheck_is_disabled")
    @patch("checkers_py.hangcheck_checker.check_non_zero_pre_emption_timeouts")
    @patch("checkers_py.hangcheck_checker.are_intel_gpus_found", return_value=False)
    ...
    @patch("checkers_py.hangcheck_checker.check_hangcheck_is_disabled")
    @patch("checkers_py.hangcheck_checker.check_non_zero_pre_emption_timeouts")
    @patch("checkers_py.hangcheck_checker.are_intel_gpus_found", return_value=True)
...
class TestCheckHangcheckIsDisabled(unittest.TestCase):
    ...
    @patch("checkers_py.hangcheck_checker._check_hangcheck_in_grub")
    @patch("checkers_py.hangcheck_checker._check_hangcheck_in_config")
