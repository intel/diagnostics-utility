...
from py_checkers_samples import py_checker_sample_2  # noqa: E402
...
class TestExamplePyChecker2(unittest.TestCase):
    ...
    def test_run_checker1_positive(self):
        ...
        actual = py_checker_sample_2.run_checker2({})
    ...
    def test_get_api_version_returns_str(self):
        ...
        actual = py_checker_sample_2.get_api_version()
    ...
    def test_get_check_list_returns_list_metadata(self):
        ...
        check_list = py_checker_sample_2.get_check_list()
